...
export default function Settings() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#041b17] to-[#020b0a] text-[#d8fff5]">
      {/* HEADER */}
      <header className="h-16 px-8 flex justify-between items-center border-b border-emerald-400/30">
        <div className="flex items-center gap-3">
          <img
            src={logo}
            alt="CREDEX Logo"
            className="w-8 h-8 object-contain drop-shadow-[0_0_6px_rgba(0,255,213,0.6)]"
          />
          <span className="text-xl font-semibold text-emerald-400">
            CREDEX<span className="text-emerald-100">.io</span>
          </span>
        </div>

        <div className="flex items-center gap-4">
          <span className="text-sm">Settings</span>
          <div className="w-8 h-8 rounded-full border-2 border-emerald-400 flex items-center justify-center font-bold">
            M
          </div>
        </div>
      </header>
