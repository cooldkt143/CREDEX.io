...
const ResumeBuilder = () => {
  ...
  const handleUpload = (parsedJson, id) => {
  console.log("Parsed resume received:", parsedJson);
  ...
  const renderStep = () => {
    switch (currentStep) {
      case 1:
        return <ResumeSource onCreate={handleCreate} onResumeParsed={handleUpload} />;
      case 2:
        return <EditDetails initialData={resumeData} />;
      case 3:
